...
CARD$P.variable_en = paste0("deltaBFI-Wal_", Horizon)
...
CARD$P.variable_fr = paste0("deltaBFI-Wal_", Horizon)
...
CARD$P2.funct = list("deltaBFI-Wal_H1"=get_deltaX,
                     "deltaBFI-Wal_H2"=get_deltaX,
                     "deltaBFI-Wal_H3"=get_deltaX)
CARD$P2.funct_args = list(list("BF-Wal", "date",
                               past=H0, futur=H1,
